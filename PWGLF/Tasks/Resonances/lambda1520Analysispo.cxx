...
struct Lambda1520Analysispo {
  ...
  void init(InitContext const&)
  {
    ...
    allHistograms.add("QAbefore/trackEta", "Track pseudorapidity (before cuts)",
                      kTH1F, {{50, -1.0, 1.0}});
    allHistograms.add("QAbefore/trackPt", "Track pT (before cuts)", kTH1F,
                      {axisMomentumForPID});
    allHistograms.add("QAbefore/trackPhi",
                      "Track azimuthal angle (before cuts)", kTH1F,
                      {{72, 0, 6.2832}});
    allHistograms.add("QAbefore/trackEtaVsPhi",
                      "Track eta vs phi (before cuts)", kTH2F,
                      {axisPseudorapidity, {72, 0, 6.2832}});
    ...
    allHistograms.add("QAbefore/Proton/tofNSigmaVsTPCNSigma",
                      "TOF nSigma vs TPC nSigma proton (before PID cuts)",
                      kTH2F, {axisTPCNSigma, axisTOFNSigma});
    ...
    allHistograms.add("QAafter/Proton/ptVsCentrality",
                      "Proton pT vs centrality (after cuts)", kTH2F,
                      {axisPtForPID, axisCentralityPercent});
    allHistograms.add("QAafter/Proton/dcaZVsPt",
                      "Proton DCAz vs pT (after cuts)", kTH2F,
                      {axisPtForPID, axisDCAz});
    allHistograms.add("QAafter/Proton/dcaXYVsPt",
                      "Proton DCAxy vs pT (after cuts)", kTH2F,
                      {axisPtForPID, axisDCAxy});
    ...
    allHistograms.add("QAafter/Proton/tpcNSigmaVsPt",
                      "Proton TPC nSigma vs pT (after cuts)", kTH2F,
                      {axisPtForPID, axisTPCNSigma});
    allHistograms.add("QAafter/Proton/tpcNSigmaPionContamVsPt",
                      "Proton track: TPC nSigma pion contamination check",
                      kTH2F, {axisPtForPID, axisTPCNSigma});
    allHistograms.add("QAafter/Proton/tpcNSigmaKaonContamVsPt",
                      "Proton track: TPC nSigma kaon contamination check",
                      kTH2F, {axisPtForPID, axisTPCNSigma});
    ...
    allHistograms.add("QAafter/Proton/tofNSigmaVsPt",
                      "Proton TOF nSigma vs pT (after cuts)", kTH2F,
                      {axisPtForPID, axisTOFNSigma});
    ...
    allHistograms.add("QAafter/Proton/tofNSigmaPionContamVsMomentum",
                      "Proton track: TOF nSigma pion contamination check",
                      kTH2F, {axisMomentumForPID, axisTOFNSigma});
    allHistograms.add("QAafter/Proton/tofNSigmaKaonContamVsMomentum",
                      "Proton track: TOF nSigma kaon contamination check",
                      kTH2F, {axisMomentumForPID, axisTOFNSigma});
    ...
    allHistograms.add("QAafter/Proton/tpcCrossedRowsVsPt",
                      "Proton TPC crossed rows vs pT", kTH2F,
                      {axisPtForPID, {200, 0, 200}});
    allHistograms.add("QAafter/Proton/tpcClustersFoundVsPt",
                      "Proton TPC clusters found vs pT", kTH2F,
                      {axisPtForPID, {200, 0, 200}});

    allHistograms.add("QAafter/Kaon/ptVsCentrality",
                      "Kaon pT vs centrality (after cuts)", kTH2F,
                      {axisPtForPID, axisCentralityPercent});
    allHistograms.add("QAafter/Kaon/dcaZVsPt", "Kaon DCAz vs pT (after cuts)",
                      kTH2F, {axisPtForPID, axisDCAz});
    allHistograms.add("QAafter/Kaon/dcaXYVsPt", "Kaon DCAxy vs pT (after cuts)",
                      kTH2F, {axisPtForPID, axisDCAxy});
    ...
    allHistograms.add("QAafter/Kaon/tpcNSigmaProtonContamVsMomentum",
                      "Kaon track: TPC nSigma proton contamination check",
                      kTH2F, {axisMomentumForPID, axisTPCNSigma});
    allHistograms.add("QAafter/Kaon/tpcNSigmaVsPt",
                      "Kaon TPC nSigma vs pT (after cuts)", kTH2F,
                      {axisPtForPID, axisTPCNSigma});
    ...
    allHistograms.add("QAafter/Kaon/tofNSigmaVsPt",
                      "Kaon TOF nSigma vs pT (after cuts)", kTH2F,
                      {axisPtForPID, axisTOFNSigma});
    ...
    allHistograms.add("QAafter/Kaon/tofNSigmaProtonContamVsMomentum",
                      "Kaon track: TOF nSigma proton contamination check",
                      kTH2F, {axisMomentumForPID, axisTOFNSigma});
    ...
    allHistograms.add("QAafter/Kaon/tpcCrossedRowsVsPt",
                      "Kaon TPC crossed rows vs pT", kTH2F,
                      {axisPtForPID, {200, 0, 200}});
    allHistograms.add("QAafter/Kaon/tpcClustersFoundVsPt",
                      "Kaon TPC clusters found vs pT", kTH2F,
                      {axisPtForPID, {200, 0, 200}});
    ...
    if (doprocessMC) {
      ...
      allHistograms.add("QAChecks/kaonRecoLevelPt",
                        "Reconstructed kaon pT (after PID cuts) - MC", kTH1F,
                        {axisPtForPID});
      allHistograms.add("QAChecks/protonGenLevelPt",
                        "Generated proton pT (truth level) - MC", kTH1F,
                        {axisPtForPID});
      ...
      allHistograms.add("Analysis/mcMassResolution_Lambda1520",
                        "Mass resolution (Mreco - Mgen) vs pT - Lambda(1520)",
                        kTHnSparseF,
    ...
    if (doprocessMCGen) {
      allHistograms.add("SignalLoss/mcEventSelectionCutflow",
                        "MC event selection cutflow (signal loss study)", kTH1F,
                        {{7, 0, 7}});
      ...
      allHistograms.add("SignalLoss/mTScaled_fromXiPlus",
                        "mT-scaled anti-Lambda(1520) pT from Xi+ parent",
                        kTHnSparseF, {axisPt, axisCentralityPercent});
      allHistograms.add("SignalLoss/mTScaled_fromXi0",
                        "mT-scaled Lambda(1520) pT from Xi0 parent",
                        kTHnSparseF, {axisPt, axisCentralityPercent});
      allHistograms.add("SignalLoss/mTScaled_fromAntiXi0",
                        "mT-scaled anti-Lambda(1520) pT from anti-Xi0 parent",
                        kTHnSparseF, {axisPt, axisCentralityPercent});
      allHistograms.add("SignalLoss/mTScaled_fromOmegaMinus",
                        "mT-scaled Lambda(1520) pT from Omega- parent",
                        kTHnSparseF, {axisPt, axisCentralityPercent});
      allHistograms.add("SignalLoss/mTScaled_fromOmegaPlus",
                        "mT-scaled anti-Lambda(1520) pT from Omega+ parent",
                        kTHnSparseF, {axisPt, axisCentralityPercent});
    }
  }
                                   ...
                                   int occupancyValue = 100)
  {
    ...
    for (auto const& [protonTrack, kaonTrack] :
      ...
      if (!isMixedEvent) {
        ...
        allHistograms.fill(HIST("QAbefore/Proton/tpcNSigmaVsMomentum"),
                           protonTotalMomentum, tpcNSigProton);
        if (protonTrack.hasTOF()) {
          auto tofNSigProton = protonTrack.tofNSigmaPr();
          allHistograms.fill(HIST("QAbefore/Proton/tofNSigmaVsMomentum"),
                             protonTotalMomentum, tofNSigProton);
          allHistograms.fill(HIST("QAbefore/Proton/tofNSigmaVsTPCNSigma"),
                             tpcNSigProton, tofNSigProton);
        }
        auto tpcNSigKaon = kaonTrack.tpcNSigmaKa();
        allHistograms.fill(HIST("QAbefore/Kaon/tpcNSigmaVsMomentum"),
                           kaonTotalMomentum, tpcNSigKaon);
        if (kaonTrack.hasTOF()) {
          auto tofNSigKaon = kaonTrack.tofNSigmaKa();
          allHistograms.fill(HIST("QAbefore/Kaon/tofNSigmaVsMomentum"),
                             kaonTotalMomentum, tofNSigKaon);
          allHistograms.fill(HIST("QAbefore/Kaon/tofNSigmaVsTPCNSigma"),
      ...
      if constexpr (!isMixedEvent) {
        ...
        allHistograms.fill(HIST("QAafter/Proton/ptVsCentrality"), ptProton,
                           centralityPercent);
        allHistograms.fill(HIST("QAafter/Proton/dcaZVsPt"), ptProton,
                           protonTrack.dcaZ());
        allHistograms.fill(HIST("QAafter/Proton/dcaXYVsPt"), ptProton,
                           protonTrack.dcaXY());
        allHistograms.fill(HIST("QAafter/Proton/tpcDedxVsMomentum"),
                           protonTotalMomentum, protonTrack.tpcSignal());
        allHistograms.fill(HIST("QAafter/Proton/tpcNSigmaPionContamVsPt"),
                           protonTotalMomentum, protonTrack.tpcNSigmaPi());
        allHistograms.fill(HIST("QAafter/Proton/tpcNSigmaKaonContamVsPt"),
                           protonTotalMomentum, protonTrack.tpcNSigmaKa());
        allHistograms.fill(HIST("QAafter/Proton/tpcNSigmaVsMomentum"),
                           protonTotalMomentum, tpcNSigProton);
        allHistograms.fill(HIST("QAafter/Proton/tpcNSigmaVsPt"), ptProton,
                           tpcNSigProton);
        allHistograms.fill(HIST("QAafter/Proton/tpcCrossedRowsVsPt"), ptProton,
                           protonTrack.tpcNClsCrossedRows());
        allHistograms.fill(HIST("QAafter/Proton/tpcClustersFoundVsPt"),
                           ptProton, protonTrack.tpcNClsFound());

        if (!useTPCOnlyPID && protonTrack.hasTOF()) {
          auto tofNSigProton = protonTrack.tofNSigmaPr();
          allHistograms.fill(HIST("QAafter/Proton/tofNSigmaVsMomentum"),
                             protonTotalMomentum, tofNSigProton);
        ...
        allHistograms.fill(HIST("QAafter/Kaon/ptVsCentrality"), ptKaon,
                           centralityPercent);
        allHistograms.fill(HIST("QAafter/Kaon/dcaZVsPt"), ptKaon,
                           kaonTrack.dcaZ());
        allHistograms.fill(HIST("QAafter/Kaon/dcaXYVsPt"), ptKaon,
                           kaonTrack.dcaXY());
        allHistograms.fill(HIST("QAafter/Kaon/tpcDedxVsMomentum"),
                           kaonTotalMomentum, kaonTrack.tpcSignal());
        allHistograms.fill(HIST("QAafter/Kaon/tpcNSigmaPionContamVsPt"),
                           kaonTotalMomentum, kaonTrack.tpcNSigmaPi());
        allHistograms.fill(HIST("QAafter/Kaon/tpcNSigmaProtonContamVsMomentum"),
                           kaonTotalMomentum, kaonTrack.tpcNSigmaPr());
        allHistograms.fill(HIST("QAafter/Kaon/tpcNSigmaVsMomentum"),
                           kaonTotalMomentum, tpcNSigKaon);
        allHistograms.fill(HIST("QAafter/Kaon/tpcNSigmaVsPt"), ptKaon,
                           tpcNSigKaon);
        allHistograms.fill(HIST("QAafter/Kaon/tpcCrossedRowsVsPt"), ptKaon,
                           kaonTrack.tpcNClsCrossedRows());
        allHistograms.fill(HIST("QAafter/Kaon/tpcClustersFoundVsPt"), ptKaon,
                           kaonTrack.tpcNClsFound());

        if (!useTPCOnlyPID && kaonTrack.hasTOF()) {
          auto tofNSigKaon = kaonTrack.tofNSigmaKa();
          allHistograms.fill(HIST("QAafter/Kaon/tofNSigmaVsMomentum"),
                             kaonTotalMomentum, tofNSigKaon);
          allHistograms.fill(HIST("QAafter/Kaon/tofNSigmaVsPt"), ptKaon,
                             tofNSigKaon);
